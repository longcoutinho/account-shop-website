  ...
  const CartTable = () => {
    return (
      <div className="cart-table">
            ...
            <TableBody>
              {cart.map((item, index) => (
                ...
                >
                  ...
                  <TableCell sx={{ color: "#eb1b24" }}>
                    {formatVND(item.price, true)}
                  </TableCell>
                  <TableCell>{item.amount}</TableCell>
                  <TableCell sx={{ color: "#eb1b24" }}>
                    {formatVND(item.totalPrice, true)}
                  </TableCell>
                  <TableCell>
                    <FontAwesomeIcon
        ...
        <h1 className="cart-title" style={{ marginTop: "20px" }}>
          Tổng giá trị đơn hàng:
          <span style={{ color: "#eb1b24", fontSize: "20px" }}>
            {" "}
            {formatVND(totalPrice, false)}
          </span>
        </h1>
      </div>
    );
